...
let favoriteFood = "Chicken Biriyani ";

// 2. Create a variable and store your mobile number.
let mobileNumber = 9381551411;
...
let animals = ["Lion", "Giraffe", "Tiger", "Deer", "Zebra", "Rabbit"];
...
console.log(50 > 25 ? "True" : "False");

// 33. Create ternary operator:
console.log(18 >= 21 ? "Adult" : "Minor");

// 34. Create one array with 5 city names and print third city.
let cities = ["Andhara pradesh", "Hyderabad", "Goa", "Chennai", "Bangalore"];
...
let mixedArray = ["Hello", 25, true, null, undefined];
